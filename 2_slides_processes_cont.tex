...
\begin{frame}{Примеры случайных процессов}
    ...
    \makebox[\textwidth]{\includegraphics[width=1.2\textwidth]{1_figs/process_example_2.png}}
\end{frame}
...
\begin{frame}{Предел случайного блуждания}
    ...
    \end{itemize}
    \makebox[\textwidth]{\includegraphics[width=1.2\textwidth]{2_figs/random_walk_limit.png}}
\end{frame}
...
\begin{frame}{Пример. Процесс Орнштейна-Уленбека}
    ...
    $$
    \pause
    \makebox[\textwidth]{\includegraphics[width=0.8\textwidth]{2_figs/OU.png}}
\end{frame}
